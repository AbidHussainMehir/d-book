    ...
    <Col md={4} xs={12} lg={4} xl={4}>
      ...
      >
        ...
        <Row>
          ...
          <Col md={12} xs={12}>
            <p className="text-center pt-2 pb-2 event-dates-details"> DATES AND DETAILS</p>
          </Col>
          <Col md={12} xs={12}>
            <Row>
              <Col>
                <p className="team-info text-left">Sale Start Date: {moment(startTime * 1000).format("DD MMM YYYY")}</p>
              </Col>
              <Col>
                <p className="team-info text-left">Sale End Date: {moment(time * 1000).format("DD MMM YYYY")}</p>
              </Col>
            </Row>
          </Col>
          <Col md={12} xs={12} className="text-center">
           <button className="events-team"
             onClick={() =>
                history.push(
                 `/team/${event.id}`
                )
