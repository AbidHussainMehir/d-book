...
import SalesDateCard from "../components/Events/cardReward";
import "./css/sale.css";
...
const Rewards = () => {
  ...
  const [filteredEvents, setFilteredEvents] = useState([...rewardList]);
